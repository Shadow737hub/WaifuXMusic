...
# ⬇️ Only SUDOERS can use /kill  
@app.on_message(filters.command("kill") & filters.user(SUDOERS))  
    ...
    try:  
        if option == 'f':  
            ...
            if user and 'characters' in user:  
                ...
                await message.reply_text("No characters found in the user's collection.")  
